...
\begin{itemize}[parsep=0.5ex]
  \item 10+ 年代码托管与 DevOps 实战，精通 Git 协议栈、代码评审（MR）、Webhook、多租户与权限体系等核心能力的架构与落地。
  \item AI 工程化经验扎实，熟悉 Agent 开发与集成、工作流编排与向量数据库（RAG），具备将 AI 能力落地到产品的全流程能力。
  \item B2B 解决方案与企业级交付经验丰富，主导 OEM 与私有化部署，从方案设计到离线交付与问题闭环全流程可控。
  \item 跨栈研发能力强（Java/TS/Ruby/Rust、React、IDE 插件/在线开发环境/CLI），以工具化与平台化提升研发效率与可维护性。
  \item 注重性能与稳定性，能在复杂多产品线中平衡质量与迭代速度，推动架构持续演进。
\end{itemize}

\section{\texorpdfstring{\faCogs\ 技能}{技能}}
% increase linespacing [parsep=0.5ex]
\begin{itemize}[parsep=0.5ex]
  %% [MOD] 统一“技能”表述口径，增强可读性；“AI 工程”改为更常见的“LLM/Agent 工程”措辞
...
\begin{itemize}
  ...
  \item \roletitle{开发工程师}{负责 AI 驱动的云原生在线开发平台核心架构与功能研发；参与前后端服务设计与落地，支撑 gru.ai、gbox.ai 等多产品线演进。}
\end{itemize}
...
https://gru.ai \ | \ 基于 AI 的在线测试开发平台
\role{开发工程师}{}
\begin{onehalfspacing}
\begin{itemize}
  %% [MOD] 去重：原两条“支撑工作流”重复；补充“编排/调度/集成”的具体动作
  \item 参与测试开发 Agent 的设计、开发与集成，覆盖工具调用、上下文组织与任务协作链路
  \item 负责 AI 测试开发工作流的编排与调度能力建设，保障多步骤任务的可观测性与稳定运行
\end{itemize}
\end{onehalfspacing}

\datedsubsection{\textbf{babel.cloud}}{2022年5月 -- 2025年7月}
https://babel.cloud \ | \ 面向 AI 场景的云原生在线开发平台
\role{开发工程师}{}
\begin{onehalfspacing}
\begin{itemize}
  %% [MOD] “代码管理能力”具体化；“推理与开发工作流”表述更准确
  \item 设计并实现平台代码管理能力（仓库/权限/基础操作链路对接与服务化）
  \item 集成向量数据库能力，支撑 RAG 等场景的检索与知识管理，并服务于 AI 辅助开发工作流
\end{itemize}
\end{onehalfspacing}
